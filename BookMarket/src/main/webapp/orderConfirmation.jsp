	...
	<%
		...
		if (cookies != null) {
			for (Cookie cookie : cookies) {
				...
				}else if (cookie.getName().equals("Shipping_name")) {
				...
				}else if (cookie.getName().equals("Shipping_country")) {
					shipping_country = URLDecoder.decode(cookie.getValue(), "utf-8");
				}else if (cookie.getName().equals("Shipping_zipCode")) {
					shipping_zipCode = URLDecoder.decode(cookie.getValue(), "utf-8");
				}else if (cookie.getName().equals("Shipping_addressName")) {
