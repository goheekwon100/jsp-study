	...
	<div class="container">
		<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
		  ...
		  <ul class="nav nav-pills">
		  	<!-- 회원 기능 추가 -->
		  	<!-- c:url 태그 사용시 컨텍스트 경로(contextPath) 자동 포함 -->
		  	<c:choose>
		  		...
		  		<c:otherwise>
				  	...
				  	<li class="nav-item">
				  		<a href='<c:url value="/member/logout.jsp" />' class="nav-link">로그아웃</a>
				  	</li>
				  	<li class="nav-item">
				  		<a href='<c:url value="/member/editMember.jsp" />' class="nav-link">회원 수정</a>
				  	</li>		
		  		</c:otherwise>
			  	
		  	</c:choose>
			  
			  <!-- (중요) 공통 레이아웃(헤더나 메듀)의 경우 위치에 따라 링크가 깨지는 구조이므로 절대 경로로 수정 -->	
		  	<li class="nav-item">
		  	...
		  	<li class="nav-item">
		  		<a href='<c:url value="/editBook.jsp?edit=edit" />' class="nav-link">도서 수정</a>
		  	</li>
		  	<li class="nav-item">
